...
* git branch -D [имя ветки] - данная команда позволяет удалить ветку с незафиксированными изменениями или коммитами, например, когда система отказывается это сделать.
